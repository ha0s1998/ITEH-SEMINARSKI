    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <a href="vizuelizacija.php#psihologDanas" class="page-scroll btn btn-xl">Pogledajte blogove</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Ovde možete pronaći sve blogove koji vas zanimaju</h3>
