    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-heading">Hoćete da ubacite novog psihologa ili blog?</div>
                <a href="admin.php#psihologcDanas" class="page-scroll btn btn-xl">Dodaj</a>
            </div>
        </div>
    </header>
